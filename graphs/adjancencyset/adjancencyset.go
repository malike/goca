...
func (adjacencySet AdjacencySet) GetAdjacentNodesForVertex(vertex int) map[int]bool {
	return nil
}

func (adjacencySet AdjacencySet) GetOutgoingNodesForVertex(vertex int) map[int]bool {
	return nil
}
